        ...
        <div class="md:flex ">
            ...
            <div class="py-2 md:border-r-2">
                <div class="text-center mb-2">
                    <span class="border-b-2 border-t-2 py-0.5">欲しいものリスト</span>
                </div>
                <form id="inputForm" action="{{ route('lists_store') }}" method="post">
                        ...
                        <div id="form-content">
                            ...
                            <div class="flex flex-col mb-2">
                                <span class="ml-2 text-left" for="">欲しいレベル</span>
                                <div>
                            ...
                            <div class="text-center">
                                <button
                                    id="inputButton" class="bg-emerald-500 hover:bg-emerald-700 text-white font-bold py-2 px-4  rounded-lg focus:outline-none focus:shadow-outline"
                    ...
                    <div id="list-{{ $list->id }}" class="fusen">
                        <ul>
                            <li>
                                ...
                                <i id="edit" class="fa fa-edit absolute top-1 right-1"
                                    onclick="openEditModal({{ $list->id }})"></i>
                                <i id="delete" class="fa fa-trash fa-lg absolute bottom-3 right-1 cursor-pointer"
                                    onclick="deleteAjax({{ $list->id }})"></i>
                            </li>
